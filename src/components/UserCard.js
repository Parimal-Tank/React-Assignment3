...
const UserCard = (props) => {
  ...
  const { data, setData, allData, index } = props;
  ...
  const handleDelete = (id) => {
    const filteredPeople = allData.filter((item) => item.id !== id);
    setData(filteredPeople);
  };

  return (
    <Col xl={3} lg={3} md={4} sm={6} xs={12}>
      <Card key={data.user.id} className="my-2 cards">
        <CardHeader>
          <div className="d-flex justify-content-center">
            <img
              src={`https://avatars.dicebear.com/v2/avataaars/${data.user.name}.svg?options[mood][]=happy`}
        ...
        <CardBody>
          <CardTitle tag="h5">{data.user.name}</CardTitle>
          <CardText>
          ...
          <div className="cardfooter d-flex">
            <div style={{ borderRight: "1px solid black" }}>
              <button className="btn btn-link" onClick={handleClick}>
                <i aria-label="icon: heart" className="heart-decoration">
                  {isActive ? (
                    <svg
                      width="18px"
                      height="18px"
            ...
            <div>
              ...
              >
                <i aria-label="icon: delete" className="icon-decoration">
                  <svg
                    viewBox="64 64 896 896"
                    className=""
                    data-icon="delete"
